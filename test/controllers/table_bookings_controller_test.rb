...
class TableBookingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table_booking" do
    assert_difference('TableBooking.count') do
      post table_bookings_url, params: { table_booking: { arrive_time: @table_booking.arrive_time, cat_id: @table_booking.cat_id, discount: @table_booking.discount, payment_time: @table_booking.payment_time, user_id: @table_booking.user_id } }
    end
  ...
  test "should update table_booking" do
    patch table_booking_url(@table_booking), params: { table_booking: { arrive_time: @table_booking.arrive_time, cat_id: @table_booking.cat_id, discount: @table_booking.discount, payment_time: @table_booking.payment_time, user_id: @table_booking.user_id } }
